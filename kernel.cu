...
#pragma unroll 
			for (short i = 0; i < tri_len; i++)
			{
...

				{
					...
					htg_diff.x = our_v.vxy.x - opp_v.vxy.x;
					htg_diff.y = our_v.vxy.y - opp_v.vxy.y;
					htg_diff.z = our_v.viz - opp_v.viz;
				}
...
#pragma unroll 
			...
			{	
				...
				if (bUsableSide)
				{
					...
					short iprev = i - 1; if (iprev < 0) inext = 5;
					v4 our_v, prev_v, opp_v, next_v;
...
#pragma unroll 
			for (int i = 0; i < tri_len; i++)
			{
				...
				f64_vec3 htg_diff;
				{
					...
					htg_diff.x = our_v.vxy.x - opp_v.vxy.x;
					htg_diff.y = our_v.vxy.y - opp_v.vxy.y;
					htg_diff.z = our_v.vez - opp_v.vez;
				}
				{
					f64_vec2 opp_B;
					f64 opp_ita, opp_nu;
